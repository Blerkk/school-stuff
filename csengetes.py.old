...
def t1():
    while True:
        #1.ora
        csengetesValasztas(hetfo, jelzocsengo, '08:13')
        csengetesValasztas(hetfo, becsengo, '08:15')
        csengetesValasztas(hetfo, kicsengo, '09:10')
        #2.ora
        csengetesValasztas(hetfo, jelzocsengo, '09:17')
        csengetesValasztas(hetfo, becsengo, '09:20')
